...
public class MainActivity extends Activity implements DialogInterface.OnDismissListener {
    ...
    public static  final String TAG = "com.sapientia.ernyoke.dailyselfie";
    ...
    private com.sapientia.ernyoke.dailyselfie.TimePickerDialog timerDialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timerDialog = new com.sapientia.ernyoke.dailyselfie.TimePickerDialog(this);
        ...
        switch (requestCode) {
            case ACTION_TAKE_PHOTO: {
                if(resultCode == RESULT_OK) {
                    ...
                    if(taken != null) {
                        Bitmap small = resizeImage(taken, 120);
